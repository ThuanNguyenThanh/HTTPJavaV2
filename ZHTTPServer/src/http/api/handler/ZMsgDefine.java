...
public class ZMsgDefine {
    ...
    public static final String RDS_MSG_INFO_FIELD_TIME_PROCCESS   = "ns:timeproccess";
    public static final String RDS_MSG_INFO_FIELD_RESULT          = "ns:result";

    public static final String MAX_TIME_PROCCESS                  = "ns:maxtimeproccess";
    public static final String MIN_TIME_PROCCESS                  = "ns:mintimeproccess";
    public static final String AVG_TIME_PROCCESS                  = "ns:avgtimeproccess";
